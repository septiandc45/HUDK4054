...
|         Variable         | Variable Name | Level of Measurement | Allowed Value | Description |
|--------------------------|---------------|----------------------|---------------|-------------|
...
| Psychological Well-Being | WB_PSYCHO     | Interval             | 10-36         | Students' psychological well-being in the past 6 months |
| Social Well-Being        | WB_SOCIAL     | Interval             | 6-24          | Students' social well-being in the past 6 months |
...
1. **Challenge in selecting the content**: As mentioned in reference videos, the first challenge I faced was determining which information I'd like to include in this file. I noticed that it should be informative but not too long. I overcame this challenge by reflecting and asking myself what I hope to be presented on that file if I read someone else's file. I also looked at the example file you gave to help me decide which sections that are relevant to my project.
2. **Technical challenges in writing the codes**: This is my first time writing a document using Markdown as well as using Git Hub. I found that coding is very challenging but also intuitive. At first, I was confused how to start. I could not even write headings and subheadings. To overcome these challenges, I asked ChatGPT for some specific questions such as how to bold the text and I learned that I have to use the double asterisk (**) to do that. The overall process was time-consuming because I learned everything from scratch but the final product was quite rewarding for me.
